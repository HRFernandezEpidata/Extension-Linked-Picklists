define(["require", "exports", "./ControlsManager"], function (require, exports, ControlsManager_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    const inputPAT = document.getElementById("pat");
    ...
    function updateViewControlValues() {
        ...
        ControlsManager_1.ControlsManager.getAllControls(inputPAT.value).then((result) => {
    ...
    `;
        const orgValues = control.getValuesOrganization();
    ...
    `;
        const projValues = control.getValuesProjects();
